                ...
                ? (
                    <div className="flex gap-2 mt-2">
                        <AutoResizeTextArea
                            ...
                            data-cy="task-input"
                        />
                        <button onClick={handleAddTask} data-cy="save-task-button">
                            <Check
                                size={20}
                                className="text-green-600 cursor-pointer hover:text-green-800 dark:text-white"
                            />
                        </button>
                        <button onClick={() => setAddingTask(false)}>
                            <X
                                size={20}
                                className="text-gray-400 cursor-pointer hover:text-gray-500 dark:text-white"
                            />
                        </button>
                    </div>
                )
