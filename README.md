...
> **Nota:** Con el fin de no obstaculizar la revisión de la actual prueba y agilizar la ejecución correcta de la aplicación se ha creado una base de datos temporal con credenciales netamente de prueba y proximamente se volveran inutilizables.
```env
